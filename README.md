# Setting Up the HOTELLIE Booking App

This guide will walk you through the process of setting up the Hotellie Booking App on your local machine.
...
```bash
git clone https://github.com/normainobary2021/hotellie.git
cd hotellie
```
